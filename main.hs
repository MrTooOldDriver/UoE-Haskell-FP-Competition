...
pointsList = [] 
                ++
             [  ( ( -1.0, -0.01 ) ,  ( -0.1, 1.0 ) ,  ( 0.2, -0.20 ) , ( 1.0, 0.010 ) ),
                ( ( -1.0, -0.02 ) ,  ( -0.1, 1.0 ) ,  ( 0.2, -0.21 ),  ( 1.0, 0.009 ) ),
                ( ( -1.0, -0.03 ) ,  ( -0.1, 1.0 ) ,  ( 0.2, -0.22 ) , ( 1.0, 0.008 ) ),
                ( ( -1.0, -0.04 ) ,  ( -0.1, 1.0 ) ,  ( 0.2, -0.23 ) , ( 1.0, 0.007 ) ),
                ( ( -1.0, -0.05 ) ,  ( -0.1, 1.0 ) ,  ( 0.2, -0.24 ) , ( 1.0, 0.006 ) )]
                ++
             [  ( ( -1.0, -0.075 ) ,  ( -0.1, 0.975 ) ,  ( 0.2, -0.25 ) , ( 1.0, 0.005 ) ),
                ( ( -1.0, -0.100 ) ,  ( -0.1, 0.950 ) ,  ( 0.2, -0.26 ),  ( 1.0, 0.004 ) ),
                ( ( -1.0, -0.125 ) ,  ( -0.1, 0.925 ) ,  ( 0.2, -0.27 ) , ( 1.0, 0.003 ) ),
                ( ( -1.0, -0.150 ) ,  ( -0.1, 0.900 ) ,  ( 0.2, -0.28 ) , ( 1.0, 0.002 ) ),
                ( ( -1.0, -0.175 ) ,  ( -0.1, 0.875 ) ,  ( 0.2, -0.29 ) , ( 1.0, 0.001 ) )]
                ++
             [  ( ( -1.0, -0.200 ) ,  ( -0.1, 0.850 ) ,  ( 0.2, -0.30 ) , ( 1.0, -0.001 ) ),
                ( ( -1.0, -0.225 ) ,  ( -0.1, 0.825 ) ,  ( 0.2, -0.31 ),  ( 1.0, -0.002 ) ),
                ( ( -1.0, -0.250 ) ,  ( -0.1, 0.800 ) ,  ( 0.2, -0.32 ) , ( 1.0, -0.003 ) ),
                ( ( -1.0, -0.275 ) ,  ( -0.1, 0.775 ) ,  ( 0.2, -0.33 ) , ( 1.0, -0.004 ) ),
                ( ( -1.0, -0.300 ) ,  ( -0.1, 0.750 ) ,  ( 0.2, -0.34 ) , ( 1.0, -0.005 ) )]       
                ++
             [  ( ( -1.0, -0.325 ) ,  ( -0.1, 0.725 ) ,  ( 0.2, -0.35 ) , ( 1.0, -0.006 ) ),
                ( ( -1.0, -0.335 ) ,  ( -0.1, 0.725 ) ,  ( 0.2, -0.36 ),  ( 1.0, -0.007 ) ),
                ( ( -1.0, -0.345 ) ,  ( -0.1, 0.725 ) ,  ( 0.2, -0.37 ) , ( 1.0, -0.008 ) ),
                ( ( -1.0, -0.355 ) ,  ( -0.1, 0.725 ) ,  ( 0.2, -0.38 ) , ( 1.0, -0.009 ) ),
                ( ( -1.0, -0.365 ) ,  ( -0.1, 0.725 ) ,  ( 0.2, -0.39 ) , ( 1.0, -0.010 ) )]
